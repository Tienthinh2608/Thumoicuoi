...
/** Tra cứu bản đồ / iframe embed (cùng địa điểm với `venue.address`) */
...
const INVITE = {
  ...
  ceremonyHeadline: 'THAM DỰ LỄ CƯỚI LAN ANH & TỰ CHINH',
  ceremonyPhotos: {
  ...
  venue: {
    name: 'TƯ GIA NHÀ GÁI',
    address: 'Số nhà 123 - Khu Phố Kim Bảng - Phường Phù Khê - Tỉnh Bắc Ninh',
    mapsUrl: `https://www.google.com/maps/place/C%E1%BB%ADa+H%C3%A0ng+T%E1%BA%A1p+H%C3%B3a+%C3%81nh+Nh%E1%BA%ADt/@21.1437484,105.9408187,812m/data=!3m2!1e3!4b1!4m6!3m5!1s0x3135064956c23f39:0x96904f80d4bdd9f3!8m2!3d21.1437484!4d105.9408187!16s%2Fg%2F11jg86948l!18m1!1e1?entry=ttu&g_ep=EgoyMDI2MDMzMS4wIKXMDSoASAFQAw%3D%3D`,
    /** iframe Google Maps (cùng query với mapsUrl) */
    mapsEmbedSrc: `https://www.google.com/maps?q=${encodeURIComponent(VENUE_MAP_QUERY)}&z=16&output=embed`,
  },
  bank: {
    label: 'VIETCOMBANK - NGUYEN THI LAN ANH',
    number: '1013065159',
    /** QR / ảnh ngân hàng (`public/Anh/`) */
    picture: `${process.env.PUBLIC_URL}/Anh/Nganhang.png`,
  },
